...
#SBATCH --output=/home/sagnik/Research/Hierarchical_AMP/Slurm_scripts/pred_nl_comp_lin/slurm_out_%A_%a.out
#SBATCH --error=/home/sagnik/Research/Hierarchical_AMP/Slurm_scripts/pred_nl_comp_lin/slurm_err_%A_%a.err
...
python Python_scripts/pred_err_vary_n_nl_linear.py $n