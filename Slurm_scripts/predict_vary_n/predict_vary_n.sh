...
#SBATCH --output=/home/sagnik/Research/Hierarchical_AMP/Slurm_scripts/predict_vary_n/slurm_out_%A_%a.out
#SBATCH --error=/home/sagnik/Research/Hierarchical_AMP/Slurm_scripts/predict_vary_n/slurm_err_%A_%a.err
...
python Python_scripts/pred_err_vary_n.py $n