...
#SBATCH --output=Slurm_scripts/vary_meth/slurm_out_%A_%a.out
#SBATCH --error=Slurm_scripts/vary_meth/slurm_err_%A_%a.err
...
python Python_scripts/cluster_diff_meth.py $n