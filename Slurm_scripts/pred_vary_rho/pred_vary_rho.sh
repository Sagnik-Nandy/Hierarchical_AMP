...
#SBATCH --output=/home/sagnik/Research/Hierarchical_AMP/Slurm_scripts/pred_vary_rho/slurm_out_%A_%a.out
#SBATCH --error=/home/sagnik/Research/Hierarchical_AMP/Slurm_scripts/pred_vary_rho/slurm_err_%A_%a.err
...
python Python_scripts/pred_error_vary_rho.py $n